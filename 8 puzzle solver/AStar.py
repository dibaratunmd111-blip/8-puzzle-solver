...
def main(page: ft.Page):
    ...
    def solve(e):
        ...
        t0 = time.time()
        goal_node, visited_states = solve_astar(start, goal)
        t1 = time.time()
        ...
        if goal_node:
            ...
            result.value = f"A* | Steps: {len(path)-1} | Nodes: {len(visited_states)} | Time: {t1-t0:.2f}s"
    ...
    page.add(
        ft.Text("8-Puzzle A* Solver", size=32, weight="bold"),
        grid,
        ft.Row(
            [
